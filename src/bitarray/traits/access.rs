...
//!
//! This module defines the `BitArrayAccess` trait, which provides
...
pub trait BitArrayMutAccess: BitArrayAccess {
    ...
    /// - Packed (e.g. word-backed) backends use a proxy such as `BitRef<'a>`
    ...
    type BitMut<'a>: core::ops::DerefMut<Target = bool>
    where
        Self: 'a;
